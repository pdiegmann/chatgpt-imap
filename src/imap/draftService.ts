...
import { decodeEmailRef, encodeEmailRef } from "../utils/crypto.js";
import { buildQuoteText, ensureReSubject } from "../utils/mime.js";
...
export async function createDraft(
	...
	const appendResult = await client.append(draftsFolder, rawMessage, [
		"\\Draft",
		"\\Seen",
	]);
	...
	let uidValidity = 1;
	try {
		// biome-ignore lint/complexity/useOptionalChain: appendResult can be "false" which would not have "uid" property, but if it's an object it should have "uid"
